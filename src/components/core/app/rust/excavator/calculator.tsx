...
export function ExcavatorCalculator() {
  ...
  const [fuelInput, setFuelInput] = useState<string>(dieselFuel.toString());
  ...
  // Handle fuel input blur
  const handleFuelBlur = () => {
    const numValue = parseInt(fuelInput);
  ...
  return (
    <div className='space-y-6'>
      {/* Header with title and operation selector */}
